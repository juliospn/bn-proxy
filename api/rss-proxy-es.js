...
app.get('/feed-es', async (req, res) => {
  try {
    ...
    await translateContent(result, 'es'); // Definir o idioma de destino para espanhol
...
async function translateContent(feed, targetLanguage) {
